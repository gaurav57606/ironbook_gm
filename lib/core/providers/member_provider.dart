...
final filteredMembersProvider = Provider<List<MemberSnapshot>>((ref) {
  ...
  // This eliminates redundant O(N) list iterations and unnecessary intermediate memory allocations.
  // Impact: Reduces filtering time significantly, especially as member counts grow.
  for (final m in members) {
