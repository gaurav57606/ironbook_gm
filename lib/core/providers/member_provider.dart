...
final filteredMembersProvider = Provider<List<MemberSnapshot>>((ref) {
  ...
  // Performance Optimization: Single-pass filtering replaces chained .where().toList()
  // This avoids redundant O(N) list iterations and unnecessary intermediate memory allocations.
