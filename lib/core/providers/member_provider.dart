...
final filteredMembersProvider = Provider<List<MemberSnapshot>>((ref) {
  ...
  // Single-pass filter to avoid O(N) chained iterations and intermediate list allocations.
  // Benchmarks show significant improvements by combining search and tab filters.
