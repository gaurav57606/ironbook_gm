...
final filteredMembersProvider = Provider<List<MemberSnapshot>>((ref) {
  ...
  // Performance Optimization: Replaced chained .where(...).toList() calls with
  // a single-pass loop. This prevents redundant O(N) list iterations and
  // intermediate memory allocations by evaluating all filters simultaneously.
