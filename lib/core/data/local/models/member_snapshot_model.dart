...
class MemberSnapshot extends HiveObject {
  ...
  int getDaysRemaining(DateTime relativeTo) {
    ...
    // Optimization: Using DateTime.utc avoids expensive OS timezone lookups.
    // Integer division by Duration.millisecondsPerDay is significantly faster
    // than allocating multiple objects for DateTime.difference().inDays.
