...
class $OwnerProfilesTable extends OwnerProfiles
  ...
  late final GeneratedColumn<bool> isSynced = GeneratedColumn<bool>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("is_synced" IN (0, 1))'),
      defaultValue: const Constant(false));
  static const VerificationMeta _ownerPhotoPathMeta =
      const VerificationMeta('ownerPhotoPath');
  @override
  late final GeneratedColumn<String> ownerPhotoPath = GeneratedColumn<String>(
      'owner_photo_path', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns => [
        gymName,
    ...
    if (data.containsKey('owner_photo_path')) {
      context.handle(
          ...
          ownerPhotoPath.isAcceptableOrUnknown(
              data['owner_photo_path']!, _ownerPhotoPathMeta));
    }
    return context;
  }
  ...
  OwnerProfile map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return OwnerProfile(
      ...
      ownerPhotoPath: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}owner_photo_path']),
    );
  }
...
class OwnerProfile extends DataClass implements Insertable<OwnerProfile> {
  ...
  OwnerProfile copyWith(
      ...
      OwnerProfile(
        ...
        isSynced: isSynced ?? this.isSynced,
        ownerPhotoPath:
            ownerPhotoPath.present ? ownerPhotoPath.value : this.ownerPhotoPath,
      );
...
class $NotificationsTable extends Notifications
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, title, body, timestamp, category, isRead, payload];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Notification extends DataClass implements Insertable<Notification> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, body, timestamp, category, isRead, payload);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$OwnerProfilesTableAnnotationComposer
  ...
  GeneratedColumn<String> get ownerPhotoPath => $composableBuilder(
      column: $table.ownerPhotoPath, builder: (column) => column);
}
...
class $$NotificationsTableFilterComposer
    extends Composer<_$OutboxDatabase, $NotificationsTable> {
...
class $$NotificationsTableTableManager extends RootTableManager<
    ...
    (
      Notification,
      BaseReferences<_$OutboxDatabase, $NotificationsTable, Notification>
    ),
    Notification,
    PrefetchHooks Function()> {
  $$NotificationsTableTableManager(
      _$OutboxDatabase db, $NotificationsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
