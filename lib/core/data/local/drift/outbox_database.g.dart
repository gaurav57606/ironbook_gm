...
class $NutritionPlansTable extends NutritionPlans
  ...
  late final GeneratedColumn<int> dailyCalories = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _adherenceMeta =
      const VerificationMeta('adherence');
  @override
  late final GeneratedColumn<double> adherence = GeneratedColumn<double>(
      'adherence', aliasedName, false,
      type: DriftSqlType.double,
      requiredDuringInsert: false,
  ...
  late final GeneratedColumn<int> waterGoalMl = GeneratedColumn<int>(
      'water_goal_ml', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
  ...
  NutritionPlan map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NutritionPlan(
      ...
      adherence: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}adherence'])!,
...
class NutritionPlan extends DataClass implements Insertable<NutritionPlan> {
  ...
  @override
  int get hashCode => Object.hash(id, memberId, planName, dailyCalories,
      adherence, waterGoalMl, hmacSignature);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $MealItemsTable extends MealItems
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, memberId, foodName, grams, calories, timestamp, hmacSignature];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $WaterLogsTable extends WaterLogs
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, memberId, amountMl, timestamp, hmacSignature];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class WaterLog extends DataClass implements Insertable<WaterLog> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, memberId, amountMl, timestamp, hmacSignature);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WaterLog &&
...
class $$NutritionPlansTableFilterComposer
    extends Composer<_$OutboxDatabase, $NutritionPlansTable> {
  ...
  ColumnFilters<double> get adherence => $composableBuilder(
      column: $table.adherence, builder: (column) => ColumnFilters(column));
...
class $$NutritionPlansTableOrderingComposer
  ...
  ColumnOrderings<double> get adherence => $composableBuilder(
      column: $table.adherence, builder: (column) => ColumnOrderings(column));
...
class $$NutritionPlansTableTableManager extends RootTableManager<
    ...
    (
      NutritionPlan,
      BaseReferences<_$OutboxDatabase, $NutritionPlansTable, NutritionPlan>
    ),
    NutritionPlan,
    PrefetchHooks Function()> {
  $$NutritionPlansTableTableManager(
      _$OutboxDatabase db, $NutritionPlansTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$MealItemsTableFilterComposer
    extends Composer<_$OutboxDatabase, $MealItemsTable> {
...
class $$MealItemsTableTableManager extends RootTableManager<
    ...
    (MealItem, BaseReferences<_$OutboxDatabase, $MealItemsTable, MealItem>),
    MealItem,
    PrefetchHooks Function()> {
  $$MealItemsTableTableManager(_$OutboxDatabase db, $MealItemsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$WaterLogsTableFilterComposer
    extends Composer<_$OutboxDatabase, $WaterLogsTable> {
...
class $$WaterLogsTableTableManager extends RootTableManager<
    ...
    (WaterLog, BaseReferences<_$OutboxDatabase, $WaterLogsTable, WaterLog>),
    WaterLog,
    PrefetchHooks Function()> {
  $$WaterLogsTableTableManager(_$OutboxDatabase db, $WaterLogsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
