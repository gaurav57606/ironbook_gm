...
class MembersListScreen extends ConsumerWidget {
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                ...
                prefixIcon:
                    Icon(Icons.search, size: 14, color: AppColors.text3),
  ...
  Widget _buildPillTabs(WidgetRef ref) {
    ...
    // Single pass to calculate all status metrics, avoiding multiple O(N) traversals
    for (final m in all) {
      switch (m.getStatus(now)) {
  ...
  Widget _buildMemberListContainer(
      BuildContext context, List<MemberSnapshot> members) {
    if (members.isEmpty) {
      return Container(
        height: 200,
        alignment: Alignment.center,
  ...
  Widget _buildMemberItem(BuildContext context, MemberSnapshot member,
      String initials, String subtitle, String status, Color color,
      {bool isLast = false}) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle,
                      style:
                          const TextStyle(fontSize: 9, color: AppColors.text2)),
                ],
              ),
            ),
            Container(
