...
class _MemberDetailScreenState extends ConsumerState<MemberDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // to avoid generating stack traces on misses.
  ...
  Widget _buildAppBar(
      BuildContext context, MemberSnapshot member, Color color, String status) {
    return Padding(
  ...
  Widget _buildSubscriptionCard(
      MemberSnapshot member, Color color, String status) {
    return Container(
  ...
  Widget _buildTimelineItem(String title, String subtitle, String amount,
      {bool isOrange = false, bool isGreen = false, bool isLast = false}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
